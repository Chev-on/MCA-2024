...
## Task 2
### Track 1 - Allegro
<img id="myImg" src="../data/Allegro_wavefull.png" style="width:100%;max-width:700px class="center"">
 <img id="myImg" src="../data/Allegro_specfull.png" style="width:100%;max-width:700px class="center"">
